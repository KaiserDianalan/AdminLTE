        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('sample') }}" class="nav-link">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{ route('sample') }}">Home</a></li>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                            <button type="submit" class="btn btn-danger"><i
                                                    class="nav-icon fas fa-search"></i> Search</button>
                                            <button type="button" class="btn btn-danger" data-toggle="modal"
                                                data-target="#modal-default"><i class="nav-icon fas fa-file-alt"></i>
                                                New Record</button>
                                        </div>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="form-horizontal">
                                                            <div class="form-group row align-items-center"> <!-- Align items vertically in the center -->
                                                                <label class="col-sm-1 col-form-label text-right">Search</label>
                                                                <div class="col-sm-9"> <!-- Adjust column width for the input field -->
                                                                    <input type="text" class="form-control" placeholder="Input Data">
                                                                </div>
                                                                <div class="col-sm-2 text-left"> <!-- Adjust column width for the button -->
